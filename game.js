class Game{
	...
	init() {
		...
		loader.load( `${this.assetsPath}fbx/Dragon_Baked_Actions_fbx_7.4_binary.fbx`, function ( object ) {
	...
	playerControl(forward, turn){
		...
		if (forward>0){
			...
			if (this.player.action=="walk" || this.player.action=='run') this.action = 'idle';
		}
